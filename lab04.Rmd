...
```{r}
vars_to_use <- c("RI", "Na", "Mg", "Al", "Si", "K", "Ca", "Ba", "Fe", "type")
ggpairs(glass%>%select(vars_to_use))
```
...
#[1] 0.6393443
```
If we had just predicted the most common class in the training set, we would've made wrong assumptions about certain observations becuase not all of the observed observations are the same type of class. 
The difference between the classificatione error rate and the classification error rate for "WinNF" is 0.0053574. 
